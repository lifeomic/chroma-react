...
```jsx
<ColorPicker label="Name" secondaryLabel="Optional" />
```
...
```jsx
<ColorPicker placeholder="Enter your name" />
```
...
```jsx
<ColorPicker label="Name" helpMessage="Some helper text!" />
```
...
```jsx
<ColorPicker label="Name" hasError />
```
...
```jsx
<ColorPicker label="Name" hasError errorMessage="Some helper text!" />
```
...
```jsx
<ColorPicker label="Name" disabled />
```
...
```jsx
<ColorPicker label="Name" readOnly />
```
...
```jsx
<ColorPicker label="Name" color="inverse" />
```
