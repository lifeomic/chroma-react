...
test('it applies the provided className', async () => {
  ...
  const avatar = await findByTestId(testId);
  expect(hasClass(avatar, 'custom-class-name')).toBe(true);
});
...
test('it applies the clickable class when "onClick" is provided', async () => {
  ...
  const avatar = await findByTestId(testId);
  expect(hasClass(avatar, 'ChromaAvatar-clickable')).toBe(true);
});
...
test('it renders with `size=0`', async () => {
  ...
  const avatar = await findByTestId(testId);
  expect(hasClass(avatar, 'ChromaAvatar-size0')).toBe(true);
});
...
test('it renders with `size=1`', async () => {
  ...
  const avatar = await findByTestId(testId);
  expect(hasClass(avatar, 'ChromaAvatar-size1')).toBe(true);
});
...
test('it renders with `size=2`', async () => {
  ...
  const avatar = await findByTestId(testId);
  expect(hasClass(avatar, 'ChromaAvatar-size2')).toBe(true);
});
